...
import modbynth233.cards.*;

import java.util.ArrayList;

import static modbynth233.ModByNth233.characterPath;
import static modbynth233.ModByNth233.makeID;

public class Tinclad extends CustomPlayer {
    //Stats
    ...
    //Strings
    private static final String ID = makeID("Tinclad"); //This should match whatever you have in the CharacterStrings.json file
    ...
    public static class Meta {
        ...
        public static void registerCharacter() {
            BaseMod.addCharacter(new Tinclad(), CHAR_SELECT_BUTTON, CHAR_SELECT_PORTRAIT);
        }
    }
