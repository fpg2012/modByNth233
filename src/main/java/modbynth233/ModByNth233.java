...
@SpireInitializer
public class ModByNth233 implements
        StartActSubscriber,
    ...
    private static String checkResourcesPath() {
        String name = ModByNth233.class.getName(); //getPackage can be iffy with patching, so class name is used instead.
        ...
        throw new RuntimeException("\n\tFailed to find resources folder; expected it to be named \"" + name + "\"." +
                ...
                "\t\"private static final String resourcesFolder = checkResourcesPath();\"\n" +
                "\tat the top of the " + ModByNth233.class.getSimpleName() + " java file.");
    }
    ...
    private static void loadModInfo() {
        Optional<ModInfo> infos = Arrays.stream(Loader.MODINFOS).filter((modInfo)->{
            ...
            return initializers.contains(ModByNth233.class.getName());
        }).findFirst();
        if (infos.isPresent()) {
            info = infos.get();
            modID = info.ID;
    ...
    public void receiveEditCharacters() {
        Tinclad.Meta.registerCharacter();
    }

    @Override
    public void receiveStartAct() {
//        if (AbstractDungeon.actNum == 1 && AbstractDungeon.player.chosenClass == AbstractPlayer.PlayerClass.DEFECT) {
//            AbstractCard c = CardLibrary.getCard("modByNth233:StrongStrike");
